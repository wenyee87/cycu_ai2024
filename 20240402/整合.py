...
#read shape file
df_taiwan=gpd.read_file('/workspaces/cycu_ai2024/COUNTY_MOI_1090820.shp')
...
# 打上標題 '11022150温浥勛'
plt.title('11022150 wen yi xun',)
plt.savefig('11022150温浥勛.png', dpi=300, bbox_inches='tight')
plt.show()
